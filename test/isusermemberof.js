...
describe('ActiveDirectory', function() {
  describe('#isusermemberof()', function() {
    ...
    it('should return false if the username (sAMAccountName) is a member of the groupName (commonName)', function(done) {
    ...
    it('should return false if the username (userPrincipalName) is not a member of the groupName (commonName)', function(done) {
    ...
    it('should return false if the username (distinguishedName) is not a member of the groupName (commonName)', function(done) {
