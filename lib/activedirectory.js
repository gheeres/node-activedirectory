...
ActiveDirectory.prototype.findUser = function() {
  var args = arguments, self = this, opts, username, 
      includeMembership, callback = _.last(arguments);

  if (typeof args[0] === "string" && args.length === 2) {
    username = args[0]
  } else if (typeof args[0] === "object" && typeof args[1] === "string" && args.length === 3) {
    opts = args[0]
    username = args[1]
  } else if (typeof args[0] === "object" && typeof args[1] === "string" && typeof args[2] === "boolean" && args.length === 4) {
    opts = args[0]
    username = args[1]
    includeMembership = args[2]
  } else {
    callback("wrong method signature!");
  }
